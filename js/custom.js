...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const navbar_serv = document.querySelector(".navbar_serv");
  
    menuIcon.addEventListener("click", function (event) {
      // Stop the click event from propagating to the document level
      event.stopPropagation();
  
      navbar_serv.classList.toggle("active");
      navbar.classList.toggle("active");
    });
  
    // Close the navbar when a link inside it is clicked
    const navbarLinks = document.querySelectorAll(".navbar_serv a");
  
    navbarLinks.forEach(function (link) {
      link.addEventListener("click", function (event) {
        event.stopPropagation(); // Stop the click event from propagating
        navbar_serv.classList.remove("active");
...
//   }
    ...
    function sliderPortfolio($el = $(document)) {
        ...
        function slideChange(swiper) {
            ...
            activeVideo(swiper);
            const [newNum, oldNum, newContent, oldContent] = getContent(swiper, contentSlider), [newTitle, oldTitle] = [Array.from(newContent.querySelectorAll('.title .char') || []), Array.from(oldContent.querySelectorAll('.title .char') || [])],
...
//   $('.navbar_serv a').on('click', function() {
//     $('.navbar-collapse').collapse('hide');
//   });

//   // Close the navbar when clicking anywhere on the document
//   $(document).on('click', function (e) {
//     if (!$(e.target).closest('.navbar_serv').length) {
//       $('.navbar-collapse').collapse('hide');
//     }
//   });
...
document.addEventListener('DOMContentLoaded', function() {
    var upButton = document.getElementById('Top_icon');
